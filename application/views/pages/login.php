  ...
  <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
    <div class="right mx-lg-0 mx-auto">
      ...
      <p class="caption-text">
        ...
        registered on the bootcamp.
      </p>
      <form style="margin-top: 1.5rem" action="<?= site_url('Seminar/checked') ?>" method="post">
      ...
      <div style="margin-top: 1rem">
        <label for="" class="d-block input-label">Secret Key</label>
        <div class="d-flex w-100 div-input">
          <svg class="icon" style="margin-right: 1rem" width="24" height="24" viewBox="0 0 24 24" fill="none"
          xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        <input class="input-field border-0" type="password" name="pwd" id="pwd"
...
<p class="text-center bottom-caption">
  ...
  <span class="green-bottom-caption">Contact Administrator</span>
</p>
</div>
</div>
</div>
